...
**Kết quả thực tế (A/B Comparison — 2026-04-13):**
...
> **Nhận xét:** Variant Hybrid không vượt trội baseline trên tổng thể. Hybrid gây regression ở q07 (Approval Matrix: Completeness 3→1) do đưa vào chunks nhiễu từ nhiều tài liệu, khiến LLM không định vị được câu trả lời. **Baseline Dense được chọn là config tốt nhất** cho tập corpus này.
